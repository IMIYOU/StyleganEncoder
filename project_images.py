...
def project_image(proj, src_file, dst_dir, tmp_dir, video=False):
    ...
    filename = os.path.join(dst_dir, os.path.basename(src_file)[:-4] + '.txt')
    with open(filename, 'w') as f:
        text_save(f,proj.get_dlatents()[0])
...
def main():
    ...
    parser.add_argument('--vgg16-pkl', default='https://drive.google.com/uc?id=1G8IBmcS-j2NmivsswofPjf0y_cwfe7xv', help='VGG16 network pickle filename')
